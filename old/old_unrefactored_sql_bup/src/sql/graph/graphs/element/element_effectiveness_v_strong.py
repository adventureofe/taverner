...
def main() -> int:
    ...
    GROUP BY attacker
    ORDER BY very_strong_count DESC;
    """

    df = pd.read_sql_query(query, connection)

    two_axis_bar_chart(df['element'], df['very_strong_count'], "element effectiveness very strong", "elements", "number of very strong element effectiveness", True)
