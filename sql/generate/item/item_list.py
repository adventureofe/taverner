...
item_list = [
    ...
    ("button mushroom", i["fungus"], c["white"], e["alien"], "small, delicious mushrooms"),
    ("shiitake mushroom", i["fungus"], c["brown"], e["alien"], "delicious rare mushrooms"),
    ("deathcap", i["fungus"], c["white"], e["alien"], "A deadly poisonous mushrooms"),
