    # letter, english_value, english_quantity, afrikaans_value, afrikaans_quantity, germen_value, german_quanity, latin_value, latin_quantity,  irish_value, irish_quantity, polish_value, polish_quantity, portuguese_value, portuguese_quantity, is_vowel  double_start,double_mid, double_end
scrabble_list = [
    ('a', 1,  9,  1,  9,  1,  5,  1, 9   ,1   , 13  , 1  , 9  , 1  ,14   , True, False, False, True,),
