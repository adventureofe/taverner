...
VALUES
--01.typeless
    ('thud',            01, 1, 1, 01, 01, 01, 100),
--02.alien
    ('probe',           02, 2, 1, 03, 02, 01, 100),
    ('death ray',       02, 3, 1, 08, 05, 01, 100),
    ('plasma ball',     02, 3, 1, 07, 02, 01, 100),
    ('plasma fist',     02, 2, 1, 04, 02, 01, 100),
--03.air
    ('tornado punch',   03, 2, 1, 04, 02, 01, 100),
    ('gust',            03, 3, 1, 08, 02, 01, 100),
    ('hurricane',       03, 3, 1, 08, 03, 01, 100),
    ('maelstrom',       03, 3, 1, 02, 02, 01, 100),
--04.chaos
    ('discombobulate',  04, 2, 1, 08, 05, 01, 90),
    ('warp',            04, 3, 1, 08, 02, 01, 90),
    ('perplex',         04, 3, 0, 13, 02, 01, 90),
    ('reality shift',   04, 2, 1, 02, 06, 01, 90),
--05.earth
    ('stomp',           05, 2, 1, 05, 02, 01, 100),
    ('stalactite',      05, 3, 1, 06, 02, 01, 100),
    ('earthquake',      05, 2, 1, 05, 06, 01, 100),
    ('mud shot',        05, 3, 1, 08, 02, 01, 100),
--06.electricity
    ('thunder punch',   06, 2, 1, 04, 02, 01, 100),
    ('lightning bolt',  06, 3, 1, 06, 02, 01, 100),
    ('thunder shock',   06, 3, 1, 08, 02, 01, 100),
    ('electrify',       06, 2, 1, 04, 05, 01, 100),
--07.evil
    ('backstab',        07, 2, 1, 03, 02, 01, 100),
    ('booby trap',      07, 3, 0, 03, 03, 01, 100),
    ('bite',            07, 2, 1, 12, 02, 01, 100),
    ('sucker punch',    07, 2, 2, 04, 02, 01, 100),
--08.fire
